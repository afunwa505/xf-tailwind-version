...
<body class="transition-colors duration-300 bg-white text-gray-900 dark:bg-darkBg dark:text-darkText">
  ...
  <header class="hidden md:flex fixed top-0 left-0 right-0 z-50 justify-between items-center p-4 bg-gray-100 dark:bg-darkBg shadow transition duration-300">
    ...
    <div class="flex gap-2 items-center">
      <!-- ✅ Logout -->
      <a href="logout.php" 
         class="px-4 py-2 rounded transition duration-300 bg-red-600 text-white hover:bg-red-700">LOG OUT</a>
  ...
  <!-- Main Content -->
  <main class="pt-28 max-w-3xl mx-auto px-6">
    <?php if (isset($_SESSION['username'])) : ?>
      <h1 class="text-2xl font-bold mb-6 text-center">Welcome, 
        <span class="text-orangeAccent"><?php echo htmlspecialchars($_SESSION['username']); ?></span>
      </h1>
    <?php endif; ?>

    <section class="bg-gray-100 dark:bg-[#333842] rounded shadow p-6">
      <h2 class="text-xl font-semibold mb-4">Your Library</h2>
      <ul class="space-y-3">
        <li><a href="images.php" class="block px-4 py-2 rounded hover:bg-orangeAccent hover:text-black transition duration-300">📷 Images</a></li>
        <li><a href="audios.php" class="block px-4 py-2 rounded hover:bg-orangeAccent hover:text-black transition duration-300">🎵 Audios</a></li>
        <li><a href="videos.php" class="block px-4 py-2 rounded hover:bg-orangeAccent hover:text-black transition duration-300">🎬 Videos</a></li>
      </ul>
    </section>
  </main>
